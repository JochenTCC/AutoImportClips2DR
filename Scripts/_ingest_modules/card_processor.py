...
def process_single_sd_card(label, source_drive, format_mode, project_start_date, 
                           ...
                           base_drx_dir, camera_mappings, proxy_task_queue=None, use_h265=False):
    """Verarbeitet eine SD-Karte oder ein lokales Verzeichnis mit Weitergabe an die Thread-Queue."""
